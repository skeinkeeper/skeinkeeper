...
function seedDialogue(db: Db): void {
  ...
  const base = Date.now();
  t.dialogue.append({ sessionId: "s1", speaker: "discord:alice", text: "Alice line 1", timestamp: base });
  t.dialogue.append({ sessionId: "s1", speaker: "narrator", text: "Narration", timestamp: base + 1 });
  t.dialogue.append({ sessionId: "s1", speaker: "discord:bob", text: "Bob line", timestamp: base + 2 });
  t.dialogue.append({ sessionId: "s1", speaker: "discord:alice", text: "Alice line 2", timestamp: base + 3 });
}
