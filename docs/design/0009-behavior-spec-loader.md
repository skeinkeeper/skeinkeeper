# Design Doc 0009: Behavior Spec Loader (Phase 1.6)

> Status: Accepted
> Author: maintainers
> Date: 2026-05-19
> Related ADRs: [ADR-0006 (Behavior Spec separate doc)](../adr/0006-behavior-spec-separate-doc.md), [ADR-0009 (telemetry opt-in)](../adr/0009-telemetry-opt-in.md), [ADR-0013 (warm-tier post-Foundry)](../adr/0013-warm-tier-after-foundry-source-of-truth.md)
> Related design docs: [0004 (eval harness)](./0004-eval-harness.md), [0008 (LLM provider interface)](./0008-llm-provider-interface.md)
