# Design Doc 0010: Audio-Extensible LLMProvider Interface

> Status: Accepted
> Author: maintainers
> Date: 2026-05-19
> Related ADRs: [ADR-0004 (plugin interface pattern)](../adr/0004-plugin-interface-pattern.md), [ADR-0009 (telemetry opt-in)](../adr/0009-telemetry-opt-in.md), [ADR-0010 (privacy as architecture)](../adr/0010-privacy-as-architecture.md), [ADR-0012 (drop Ruleset)](../adr/0012-drop-ruleset-plugin-interface.md)
> Related design docs: [0008 (LLM provider interface)](./0008-llm-provider-interface.md)
