# Design Doc 0024: Operator Self-Designation (Console + Slash Command)
...
> Related design docs: [0020 (operator app)](./0020-operator-app.md), [0023 (onboarding + operator channel)](./0023-session-onboarding-presence-operator-channel.md)
