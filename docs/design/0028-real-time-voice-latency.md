# Design Doc 0028: Real-Time Voice Latency (Streaming, Barge-In, Latency Masking)

> Status: Accepted
> Author: maintainers
> Date: 2026-05-21
> Related ADRs: [0003 (tool-call-only mutation)](../adr/0003-tool-call-only-state-mutation.md), [0004 (plugin interfaces)](../adr/0004-plugin-interface-pattern.md), [0006 (behavior spec separate doc)](../adr/0006-behavior-spec-separate-doc.md), [0009 (telemetry opt-in)](../adr/0009-telemetry-opt-in.md), [0010 (privacy as architecture)](../adr/0010-privacy-as-architecture.md)
> Related design docs: [0010 (audio-extensible LLM)](./0010-audio-extensible-llm-interface.md), [0011 (turn loop)](./0011-orchestrator-turn-loop.md), [0012 (voice IO)](./0012-voice-io.md), [0015 (always-listening loop)](./0015-always-listening-voice-loop.md), [0017 (voice assignment)](./0017-voice-assignment.md), [0018 (streaming STT)](./0018-streaming-stt.md)
