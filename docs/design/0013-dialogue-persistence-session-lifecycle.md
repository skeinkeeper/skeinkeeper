# Design Doc 0013: Dialogue Persistence + Session Lifecycle (Phase 2c)

> Status: Accepted
> Author: maintainers
> Date: 2026-05-19
> Related ADRs: [ADR-0008 (tenant scoping)](../adr/0008-tenant-scoping.md), [ADR-0009 (telemetry opt-in)](../adr/0009-telemetry-opt-in.md), [ADR-0010 (privacy as architecture)](../adr/0010-privacy-as-architecture.md)
> Related design docs: [0003 (erasure + export)](./0003-erasure-and-export.md), [0011 (orchestrator turn loop)](./0011-orchestrator-turn-loop.md), [0012 (voice IO)](./0012-voice-io.md)
