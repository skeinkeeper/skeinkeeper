# Design Doc 0026: 1:1 Player↔DM Side-Channels (private Q&A + private actions)

> Status: Accepted
> Author: maintainers
> Date: 2026-05-20
> Related ADRs: [0003 (tool-call-only mutation)](../adr/0003-tool-call-only-state-mutation.md), [0008 (tenant scoping)](../adr/0008-tenant-scoping.md), [0009 (telemetry opt-in)](../adr/0009-telemetry-opt-in.md), [0010 (privacy as architecture)](../adr/0010-privacy-as-architecture.md), [0014 (episodic memory campaign-scoped erasure)](../adr/0014-episodic-memory-campaign-scoped-erasure.md), [0015 (operator pre-game; AI does in-play DM actions)](../adr/0015-operator-pregame-ai-performs-in-play-dm-actions.md), [0016 (operator control parity)](../adr/0016-operator-control-parity-across-surfaces.md), [0017 (per-audience memory visibility & erasure)](../adr/0017-per-audience-memory-visibility-erasure.md)
