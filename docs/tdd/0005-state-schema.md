...
PRD refs: 5.1, 5.2
PRD-rev: 10391ba
ADR constraints: 0002, 0003, 0008, 0010, 0011, 0013
Author: maintainers
Date: 2026-05-19
...
None — this design directly implements ADR-0002 (four-tier memory), ADR-0003 (tool-call-only mutation), ADR-0008 (tenant scoping), and ADR-0010 (privacy as architecture); no PRD requirement proved infeasible or contradictory.

## Decisions to promote (ADR candidates)

None — the durable decisions here are already captured in ADR-0002, ADR-0003, ADR-0008, and ADR-0010.
