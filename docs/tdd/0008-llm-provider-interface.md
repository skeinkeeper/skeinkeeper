...
PRD refs: 5.2, 4.3
PRD-rev: 10391ba
ADR constraints: 0003, 0004, 0009, 0012, 0013
Author: maintainers
Date: 2026-05-19
Related TDDs: [0001 (telemetry library)](./0001-telemetry-library.md), [0004 (eval harness)](./0004-eval-harness.md), [0006 (tool registry)](./0006-tool-registry.md), [0007 (Foundry-as-source-of-truth)](./0007-foundry-as-source-of-truth.md)
...
Covered under Eval implications (the three-commit 1.5a/1.5b/1.5c plan).

## Failure modes & edge cases

Covered under Approach (see "### Errors" under Components & interfaces above).
...
- **Chosen:** `@anthropic-ai/sdk` (the Anthropic Node SDK) — the default provider; the operator supplies their own API key. OSS MIT-licensed client; no vendor lock-in at the interface level.
...
None — this design directly implements ADR-0004 (plugin interface pattern) and ADR-0003 (tool-call-only mutation); no PRD requirement proved infeasible or contradictory.
