...
| [0043](./0043-container-bind-and-console-credential.md)            | Container bind mode + console credential                                                         | draft; narrowly supersedes [0041](./0041-first-party-foundry-addon.md) (gateway bind table only)                                       |
| [0044](./0044-docker-compose-ship-path.md)                         | The `docker compose up` ship path                                                                | draft; depends on [0043](./0043-container-bind-and-console-credential.md)                                                              |
