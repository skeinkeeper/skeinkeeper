...
The design of this parity (the control table, the event model, the deferred `session start` gateway constraint) is in [TDD 0025](../tdd/0025-operator-control-parity.md); this ADR records the *architectural decision* that doc implements.
