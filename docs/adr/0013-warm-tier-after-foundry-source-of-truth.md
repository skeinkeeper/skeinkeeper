...
Accepted (2026-05-19). **Supersedes the warm-tier contents description in [ADR-0002](./0002-four-tier-memory-model.md).** The four-tier framing (hot / warm / cold / episodic) itself remains current; only the per-tier _contents_ are revised.

## Context

ADR-0002 (2026-05-17) defined the four-tier memory model. The warm tier was specified as: _"HP, slots, inventory, conditions, location, quest flags, faction reputation, time-of-day"_ — stored in SQLite and mutated only via tool calls.
